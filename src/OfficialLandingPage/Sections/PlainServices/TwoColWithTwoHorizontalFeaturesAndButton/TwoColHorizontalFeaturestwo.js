...
import TeamIllustrationSrc from "../images/undraw_transfer_money_rywa.svg";
...
function TwoColHorizontalFeaturestwo({
  subheading = "TOOL NUMBER TWO",
  heading = (
    <>
      Create A Direct <span tw="text-primary-600">Budget.</span>
    </>
  ),
  description = (
    <>
      Budgeting can help you make better financial decisions, and stay focused
      on your <strong>LONG-TERM FINANCIAL GOALS!</strong>
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      title: "Stay Smart",
      description:
        "By logging your expenses and income, you will be able to stay well-financed and better focused!",
...
export default TwoColHorizontalFeaturestwo;
