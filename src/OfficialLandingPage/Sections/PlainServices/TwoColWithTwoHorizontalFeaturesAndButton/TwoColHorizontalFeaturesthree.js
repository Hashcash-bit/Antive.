...
import TeamIllustrationSrc from "../images/undraw_Online_chat_re_c4lx.svg";
import { ReactComponent as SvgDotPattern } from "../images/dot-pattern.svg";
import { ReactComponent as BriefcaseIcon } from "feather-icons/dist/icons/message-square.svg";
import { ReactComponent as MoneyIcon } from "feather-icons/dist/icons/user.svg";
...
function TwoColHorizontalFeaturesthree({
  subheading = "TOOL NUMBER THREE",
  heading = (
    <>
      Be Part Of A <span tw="text-primary-600">Community.</span>
    </>
  ),
  description = (
    <>
      Having an online conversation tool really provides individuals with the
      ability to ask for <strong>help or advice.</strong>
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      title: "Get Involved",
      description:
        "Surround yourself with a great community and ask for help or advice when needed!",
    ...
    },
    {
      ...
      description:
        "Share images and get noticed, invite your friends and stay organized together!",
...
export default TwoColHorizontalFeaturesthree;
