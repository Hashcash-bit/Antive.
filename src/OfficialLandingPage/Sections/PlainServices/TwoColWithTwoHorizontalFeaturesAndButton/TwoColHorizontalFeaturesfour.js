...
import TeamIllustrationSrc from "../images/Vault.svg";
import { ReactComponent as SvgDotPattern } from "../images/dot-pattern.svg";
import { ReactComponent as BriefcaseIcon } from "feather-icons/dist/icons/database.svg";
import { ReactComponent as MoneyIcon } from "feather-icons/dist/icons/feather.svg";
...
const TextColumn = styled(Column)((props) => [
  tw`md:w-6/12 mt-16 md:mt-0 pr-5`,
  props.textOnLeft
...
function TwoColHorizontalFeaturesfour({
  subheading = "TOOL NUMBER FOUR",
  heading = (
    <>
      Have A Secret <span tw="text-primary-600">Vault.</span>
    </>
  ),
  description = (
    <>
      Having a protected vault and store all your documents at your{" "}
  ...
  const defaultFeatures = [
    {
      ...
      title: "Security",
      description:
        "The material uploaded to the vault is stored in the google servers under intense protection to ensure privacy!",
    ...
    },
    {
      ...
      description:
        "Having your files, images, videos and documents at your finger-tips creates a user friendly environment which increases productivity!",
...
export default TwoColHorizontalFeaturesfour;
